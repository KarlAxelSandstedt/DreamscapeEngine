...
//			case DS_F11: 
//			{
//				(NativeWindowFullscreenCheck(sys_win->native))
//				      ? NativeWindowWindowed(sys_win->native) 
//				      : NativeWindowFullscreen(sys_win->native);
//			} break;
//
//			case DS_F12:
//			{
//				(NativeWindowBorderedCheck(sys_win->native))
//				      ? NativeWindowBorderless(sys_win->native) 
//				      : NativeWindowBordered(sys_win->native);
//			} break;
//
//			case DS_C: 
//			{
...
//			} break;
//
//			case DS_WINDOW_CURSOR_LEAVE:
//			{
//				//fprintf(stderr, "cursor_leave\n");
//			} break;
//
//			case DS_WINDOW_FOCUS_IN:
//			{
//				//fprintf(stderr, "window_focus_in\n");
//			} break;
//
//			case DS_WINDOW_FOCUS_OUT:
//			{
//				//fprintf(stderr, "window_focus_out\n");
//			} break;
//
//			//case DS_WINDOW_EXPOSE:
//			//{
...
//			case DS_NO_EVENT:
//			{
//				fprintf(stderr, "DS_NO_EVENT\n");
//			} break;
//		}
//
//		if (text_edit_event)
//		{
//			CmdQueueSubmit(sys_win->cmd_queue, cmd_ui_text_op);
//		}
//	}
//}
